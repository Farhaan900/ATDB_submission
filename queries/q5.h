...
namespace CoGaDB{
    	...
    	for(int i=0;i<column_ptr->size();i++){
    	    	    	...
    	    	    	int n = sizeof(arr)/sizeof(arr[0]);
    	    	    	    ...
    	    	    	    for (int i = 0; i < 100; i++){
    	    	    	    	...
    	    	    	    	//chicking for condition here
    	    	    	    	if(arr[i] >= 30 && arr[i] <= 80){
    	    	    	    		continue;
    	    	    	    	}
    	    	    	    	arradd[arr[i]]+=arr[i];
    	    	    	    }
    ...
    void executeQ5(){
    	...
    	/**
    	scan  stest(column_ptr);
    	    	selection seltest(&stest);

    	    	seltest.open();
    	    	std::cout<<"printing data sel << "<<seltest.next()<<std::endl;
    	    	std::cout<<"printing data sel << "<<seltest.next()<<std::endl;
    	    	std::cout<<"printing data sel << "<<seltest.next()<<std::endl;
    	 */
    	...
    	/***/
    	        ...
    	        int* compiledResult=compiledQ5(column_ptr);

    	        std::cout<<"printing comparison values from compiled results"<<std::endl;
